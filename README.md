...
| vprogs | https://github.com/kaspanet/vprogs | Provable computation. Research. No public testnet as product. Open stack: [#149](https://github.com/kaspanet/vprogs/pull/149) rusty `eb0a856` pin, [#131](https://github.com/kaspanet/vprogs/pull/131) guest-batteries (first-consumer pin drifted), [#146](https://github.com/kaspanet/vprogs/pull/146)→[#148](https://github.com/kaspanet/vprogs/pull/148) **draft** `da2a7f26`. Guest demo: [vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) tip `a758a9b` (tn10 CUDA **runbook**, not a shipping stamp). hmoog volume > Max. |
...
| [biryukovmaxim/vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) | **Guest demo, not a public product.** 94 commits, tip `a758a9b` (21 Sep tn10 CUDA **runbook** — private multi-machine walkthrough, not a shipping stamp). Host pins kaspanet `settle-resume` = [#148](https://github.com/kaspanet/vprogs/pull/148) `da2a7f26`. Guest ELF still fork `bridge-live-lane#128dd05f`. Open [#23](https://github.com/biryukovmaxim/vprog-tictactoe/issues/23). Desk report: [`VPROG-TICTACTOE.md`](VPROG-TICTACTOE.md) · [#24](https://github.com/biryukovmaxim/vprog-tictactoe/issues/24). Related core: vprogs [#131](https://github.com/kaspanet/vprogs/pull/131) battery (first-consumer pin drifted), [#149](https://github.com/kaspanet/vprogs/pull/149) rusty `eb0a856` pin. |
