...
| vprogs | https://github.com/kaspanet/vprogs | Provable computation. Research. No public testnet as product. Open stack #131/#149/#146→[#148](https://github.com/kaspanet/vprogs/pull/148) draft. Guest demo now pins **`reorg-safety#ac67c5f9`** (defer dead lane-proof; **no open PR**, 5 ahead of #148). hmoog volume > Max. |
...
| [biryukovmaxim/vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) | **Guest demo, not a public product.** 96 commits, tip `36ccdbc` (21 Sep). Host pins kaspanet **`reorg-safety#ac67c5f9`** (5 ahead of [#148](https://github.com/kaspanet/vprogs/pull/148); **no open PR**). Guest ELF still fork `bridge-live-lane#128dd05f`. tn10 CUDA runbook `a758a9b`. Open [#23](https://github.com/biryukovmaxim/vprog-tictactoe/issues/23). Desk report: [`VPROG-TICTACTOE.md`](VPROG-TICTACTOE.md) · [#24](https://github.com/biryukovmaxim/vprog-tictactoe/issues/24). |
