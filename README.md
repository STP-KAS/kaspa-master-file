...
| tictactoe | Tip [`cc52b322`](https://github.com/biryukovmaxim/vprog-tictactoe/commit/cc52b322aa5c) (22 Sep 12:56Z), merge of [#25](https://github.com/biryukovmaxim/vprog-tictactoe/pull/25) `76030511`. Host and guest locks are both `kaspanet/vprogs` `guest-hardening#291d4f29`. That is [#156](https://github.com/kaspanet/vprogs/pull/156), which is still based on `59b30920` and does not contain the #152 gap retry `0309fd37`. The fork pin `bridge-live-lane#128dd05f` is gone. Encoder wasm vendor is `0.1.6`. Rusty pin in the lock is still `eb0a856`, one diagnostic commit behind master `ecb9b1f`. Not a product testnet. |
...
| [biryukovmaxim/vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) | **Guest demo, not a public product.** Tip `cc52b322` (22 Sep 12:56Z, #25 merged) locks **`guest-hardening#291d4f29`**. [vprogs#152](https://github.com/kaspanet/vprogs/pull/152) HEAD is `0309fd37`. The guest fork pin is gone. [#24](https://github.com/biryukovmaxim/vprog-tictactoe/issues/24). |
