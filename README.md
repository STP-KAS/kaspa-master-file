...
| vProgs | Master still [`f9b84a8`](https://github.com/kaspanet/vprogs/commit/f9b84a863a7c7c20586a9cf947550475e894f72e) (28 Jul). No release. **22 Sep ~08:32Z:** [#148](https://github.com/kaspanet/vprogs/pull/148) **closed unmerged** 07:30Z (closed head `78501881`; the old draft head was `da2a7f26`). Resume work is [#154](https://github.com/kaspanet/vprogs/pull/154), **open, not draft**, head `f84525b5`, 25 commits, base [#153](https://github.com/kaspanet/vprogs/pull/153). [#153](https://github.com/kaspanet/vprogs/pull/153) is open, not draft, one commit `3496a8c5` (cancel the lane-proof fetch on shutdown), base #147. [#152](https://github.com/kaspanet/vprogs/pull/152) is still **draft**: closed 07:29Z, reopened 07:30Z, head **`59b30920`** (`ci: drop the runner simnet suite step`). Parent of that commit is `0636cff1`. `74e24551...59b30920` is **diverged**. Stack: #147 `74ee1b7d` → #153 → #154 → #152. Unchanged this morning: #149 `51b56aab`, #131 `004a5948`, #134 `add37bed`, #136 `d2da8ad0`, #140 `28f0aee9`. No other kaspanet PR updated on 22 Sep. Research only. |
| tictactoe | Tip still [`92146b4`](https://github.com/biryukovmaxim/vprog-tictactoe/commit/92146b49406749dd8969976d1b7e5cb6bf483bd6) (21 Sep 13:49Z). **Cargo.lock still** `kaspanet/vprogs?branch=reorg-safety#74e24551`, rusty `eb0a856`. That host commit **diverged** from #152 head `59b30920` on 22 Sep. #152’s body says the app pins `0636cff1`, which is neither the lock nor HEAD. **guest/Cargo.lock** is still the fork `biryukovmaxim/vprogs?branch=bridge-live-lane#128dd05f`. Not a product testnet. |
...
| [biryukovmaxim/vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) | **Guest demo, not a public product.** Tip `92146b4`. Host lock still **`reorg-safety#74e24551`**, diverged on 22 Sep from [vprogs#152](https://github.com/kaspanet/vprogs/pull/152) head `59b30920`. Guest ELF still fork `bridge-live-lane#128dd05f`. [#24](https://github.com/biryukovmaxim/vprog-tictactoe/issues/24). |
