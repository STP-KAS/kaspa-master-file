...
| tictactoe | Tip [`ba05d924`](https://github.com/biryukovmaxim/vprog-tictactoe/commit/ba05d924e1e5) (24 Sep 12:18Z). Host and guest `Cargo.toml` name kaspanet/vprogs branch `fix/reorg-boundary-duplicate-bundles`. Both `Cargo.lock` files pin rev `3a61c0b`, draft [#164](https://github.com/kaspanet/vprogs/pull/164). The lock is the pin. It is not a floating branch tip. This commit does not change the rusty pin `eb0a856`, behind release v2.1.0 `01b532e8`. Prior tip `75950635` (23 Sep 14:33Z) locked draft [#163](https://github.com/kaspanet/vprogs/pull/163) `ea7b823`. Not a product testnet. |
