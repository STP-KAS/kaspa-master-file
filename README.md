...
| [biryukovmaxim/vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) | **Guest demo, not a public product.** Tip `75950635` (23 Sep 14:33Z) follows branch **`fix/g2-access-read-enforcement`**. Prior tip `93b75901` locked `guest-hardening#291d4f29`. [vprogs#152](https://github.com/kaspanet/vprogs/pull/152) HEAD is `0309fd37`. The guest fork pin is gone. [#24](https://github.com/biryukovmaxim/vprog-tictactoe/issues/24). |
