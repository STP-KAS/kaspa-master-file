...
| Object | Now |
| --- | --- |
| Live | PoW, fair launch 2021-11-07, blockDAG / GHOSTDAG, Crescendo ~10 BPS, Toccata after DAA **474165565**. KIP-16/17/20/21 **Active** ([kips `e4ae233`](https://github.com/kaspanet/kips/commit/e4ae2332117b5cb68bd6188e065ef885b6d17939)). rusty-kaspa release **[v2.0.1](https://github.com/kaspanet/rusty-kaspa/releases/tag/v2.0.1)** is commit **`cfafeb4c`** (15 Jun). Master [`ecb9b1f`](https://github.com/kaspanet/rusty-kaspa/commit/ecb9b1f5974b) (22 Sep 11:27Z, [#1096](https://github.com/kaspanet/rusty-kaspa/pull/1096) merged) is **not** that tag. The commit only fixes the output count inside `InvalidOutputIndex`. It is not a new consensus rule. Prior tip was `eb0a856`. [#1138](https://github.com/kaspanet/rusty-kaspa/pull/1138) `159af22d` is open, not merged (rewritten from `8c64fb93`): arithmetic-lint cleanup plus a new `CompressedParents` `SizeExceeded` bound at `u8::MAX * 2048`. Desk comment [5777320861](https://github.com/kaspanet/rusty-kaspa/pull/1138#issuecomment-5777320861). SilverScript **[v1.0.0](https://github.com/kaspanet/silverscript/releases/tag/v1.0.0)** `3ed9733`. |
