...
| --- | --- | --- | --- |
| 2026-09-19 ~14:53 | _(pending)_ | Digest fold: vprogs#147 head `51bb9d4` (adaptive-reorg-filter disable + wire-through); DK #1122 head `332ec6c`, #1121 head `06efd83`. Updated rusty/vprogs/KIP-2/intel/rnd-log. Pins hold — not shipped. | **Hold** |
