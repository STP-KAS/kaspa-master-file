...
# Receipts (older README sections)

These sections were moved here verbatim from [`README.md`](README.md) on 26 Sep 2026. They are the dated "What this pass did" receipts (11–21 Sep 2026) and the reference sections 0–10: official sites, the research forum, GitHub orgs, KIPs, people, channels, the 12 Sep news freeze and intel pack, and local corpora. Each is a receipt. Pins, counts, and statuses in it are as of the date it names.

The current board is [README **Now**](README.md#now-read-this-first). Where the two disagree, the board wins. New dated notes go to [`SNAPSHOT-HISTORY.md`](SNAPSHOT-HISTORY.md), not here.
