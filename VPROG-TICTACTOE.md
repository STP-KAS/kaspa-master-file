...
| [kaspanet/vprogs#152](https://github.com/kaspanet/vprogs/pull/152) `reorg-safety` | **Draft**. P0.1 batch-id hole; P0.2 dead lane-proof defer. GPU-abort TODO. Tictactoe host moved **onto #156** (`cc52b32`). |
