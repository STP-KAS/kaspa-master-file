...
- **Guest demo, not this org:** [biryukovmaxim/vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) (98 commits, tip `92146b4`). Host pin [vprogs#152](https://github.com/kaspanet/vprogs/pull/152) **draft** `reorg-safety#74e24551`. Guest ELF still fork `bridge-live-lane#128dd05f`. GPU-abort TODO in #152. **Do not claim vProgs live.**
