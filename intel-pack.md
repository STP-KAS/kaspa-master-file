...
| --- | --- | --- | --- |
| **R-TG-RND** | `C:\Users\<user>\Documents\atelgram rd\` | Core R&D Telegram cleans (11 files) | Critical protocol design |
| **R-DISCORD** | `C:\Users\<user>\Documents\adiscord api\` | 41 Discord channel dumps | Ecosystem, product demand, timeline |
| **R-TRANSCRIPTS** | `C:\Users\<user>\Documents\atranscriptskaspa\` | Founder/core deep dives | Architecture intent, narrative |
...
| **R-KASSMITHS** | `C:\Users\<user>\Documents\aaapikassmith\` | Kas-Smiths forum API dump | KCC20 / standards workshop |
| **R-AGENC** | `C:\Users\<user>\Documents\aatelegram agenC sol\` | AgenC Solana Telegram export + cleans | Agent-economy case study |
...
| **R-NARRATIVE-2026** | `C:\Users\<user>\Documents\kaspa-attenborough-2026\` | Attenborough Kaspa film (Sep 2026 remake of Apr 2025 CryptoQTK piece) | Public-facing ethos + fact-checked VO |
...
```powershell
# Full repo table
Invoke-Item "C:\Users\<user>\Documents\kaspa-github-repos-full.md"

# Machine filter: programmability only
Import-Csv "C:\Users\<user>\Documents\kaspa-github-repos-intel.csv" |
