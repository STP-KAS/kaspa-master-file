...
| --- | --- | --- | --- |
| 2026-09-20 ~10:51 | _(pending)_ | Digest fold: rusty #1135 `ed09a8a` (PSKB sighash opt-in), #1136 `2c0df83` (IBD 20 MiB headers); #1104 naming review (head still `a5888da`). Updated `master.json` `updated` 2026-09-20. Pins hold. | **Hold** |
