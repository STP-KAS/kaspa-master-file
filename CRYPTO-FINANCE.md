...
9. **KCC-20 is Draft.** Not a gram token. Grams = KIP-21 mass + WorkCredit. [argent-lang/kcc20-reference](https://github.com/argent-lang/kcc20-reference) is **WIP** (empty README, `#1` open) — not the standard.
...
This desk: kaspa-dapps (front door) · kaspa-master-file (this encyclopedia) · groks-wallet (TN10, public address only) · peglab-poc · ishum · argent-xai · grok-kaspa-collab · xai-reasoning-3 · kaspa-x402 tracking via sixpack.wtf.
