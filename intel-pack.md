...
- **Guest demo, not this org:** [biryukovmaxim/vprog-tictactoe](https://github.com/biryukovmaxim/vprog-tictactoe) (tip `4f27dd1`). Host pin [vprogs#152](https://github.com/kaspanet/vprogs/pull/152) **draft** `reorg-safety#59b30920`. Guest ELF still fork `bridge-live-lane#128dd05f`. Stack under: #154 (replaces closed #148) on #153 (shutdown-cancel fetch). GPU-abort TODO in #152. **Do not claim vProgs live.**
